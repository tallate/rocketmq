...
public class BrokerControllerTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        brokerConfig.setNamesrvAddr("127.0.0.1:9877");
        ...
        // 同时启动两个Broker会报错：Lock failed,MQ already started
        // 需要修改其中一个的持久化文件路径
        messageStoreConfig.setHaListenPort(10922);
        messageStoreConfig.setStorePathRootDir("/Users/huanggaochi/Downloads/broker");
